  ...
  ?>
            ...
            <?php if (
              ...
              $aktuelleSeite + $range / 2
               ...
               ?>
                <div class="-mr-px flex items-center justify-center border border-gray-200 bg-slate-200 px-4 text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400">
                    ...
                </div>
            <?php endif; ?>
