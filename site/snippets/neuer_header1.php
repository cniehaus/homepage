        ...
        <div
            ...
            <div class="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
                ...
                <div class="text-base leading-7">
                    ...
                    <p class="mt-2 text-gray-300">Consectetur vel non. Rerum ut consequatur nobis unde. Enim est quo
            ...
            <div class="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
                ...
                <div class="text-base leading-7">
                    ...
                    <p class="mt-2 text-gray-300">Quod possimus sit modi rerum exercitationem quaerat atque tenetur
                        ullam.</p>
                </div>
            </div>
            <div class="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
                ...
                <div class="text-base leading-7">
                    ...
                    <p class="mt-2 text-gray-300">Ratione et porro eligendi est sed ratione rerum itaque. Placeat
                        accusantium impedit eum odit.</p>
                </div>
            </div>
        </div>
    </div>
