...
<div class="p-4">
  ...
  <a href="<?= page("blogs")->url() ?>">
    <?php if (collection('blogs-startseite')->isNotEmpty()) {
      ...
      snippet('knopf-klein', ['subpage' => page("blogs"), 'knopftext' => "Weitere Nachrichten aus der Schule &#8594;"]);
    }

      
else {
  // Wenn keine aktuellen Artikel vorhanden sind
  snippet('knopf-klein', ['subpage' => page("blogs"), 'knopftext' => "Nachrichten aus der Schule &#8594;"]);
} ?>
  </a>
